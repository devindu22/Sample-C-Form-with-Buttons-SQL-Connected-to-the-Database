...
namespace WindowsFormsApplication1 {
    ...
    public partial class projectDataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentRow AddstudentRow(int st_Id, string st_name, string dob, string gender, string st_address, string contactNo) {
            ...
            private void InitClass() {
                ...
                this.columnst_address.MaxLength = 255;
...
namespace WindowsFormsApplication1.projectDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[student] WHERE (([st_Id] = @Original_st_Id) AND ([st_name] = @Original_st_name) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_st_address = 1 AND [st_address] IS NULL) OR ([st_address] = @Original_st_address)) AND ([contactNo] = @Original_contactNo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([st_Id], [st_name], [dob], [gender], [st_address], [" +
                "contactNo]) VALUES (@st_Id, @st_name, @dob, @gender, @st_address, @contactNo);\r\n" +
                "SELECT st_Id, st_name, dob, gender, st_address, contactNo FROM student WHERE (st" +
                "_Id = @st_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [st_Id] = @st_Id, [st_name] = @st_name, [dob] = @dob, [gender] = @gender, [st_address] = @st_address, [contactNo] = @contactNo WHERE (([st_Id] = @Original_st_Id) AND ([st_name] = @Original_st_name) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_st_address = 1 AND [st_address] IS NULL) OR ([st_address] = @Original_st_address)) AND ([contactNo] = @Original_contactNo));
SELECT st_Id, st_name, dob, gender, st_address, contactNo FROM student WHERE (st_Id = @st_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT st_Id, st_name, dob, gender, st_address, contactNo FROM dbo.student";
        ...
        public virtual int Delete(int Original_st_Id, string Original_st_name, string Original_dob, string Original_gender, string Original_st_address, string Original_contactNo) {
        ...
        public virtual int Insert(int st_Id, string st_name, string dob, string gender, string st_address, string contactNo) {
            ...
            if ((st_address == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(st_address));
            }
            if ((contactNo == null)) {
        ...
        public virtual int Update(int st_Id, string st_name, string dob, string gender, string st_address, string contactNo, int Original_st_Id, string Original_st_name, string Original_dob, string Original_gender, string Original_st_address, string Original_contactNo) {
            ...
            if ((st_address == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(st_address));
            }
            if ((contactNo == null)) {
                throw new global::System.ArgumentNullException("contactNo");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string st_name, string dob, string gender, string st_address, string contactNo, int Original_st_Id, string Original_st_name, string Original_dob, string Original_gender, string Original_st_address, string Original_contactNo) {
            return this.Update(Original_st_Id, st_name, dob, gender, st_address, contactNo, Original_st_Id, Original_st_name, Original_dob, Original_gender, Original_st_address, Original_contactNo);
        }
    }
